...
export const extractLoanType = (text) => {
...
export const parseAIResponse = (aiResponse, currentStep) => {
...
export const determineNextStep = (currentStep, formData) => {
    switch (currentStep) {
        case "loan_amount":
...
export const shouldShowSubmitButton = (aiResponse, formData, currentStep) => {
